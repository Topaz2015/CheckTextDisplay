/*
	Author:Topaz 2025
	shows how to disable wifi.
    wifi is essential for 
        uploading image file
        deleting image file
        etc...
    but once you are through developing, 
    it may be a backdoor for hackers
    hence may not be necessary.
*/
...
void setup() {
    ...
    //disable display wifi completely
    //to reenable you have to display.reset();    
    display.wifiOff(); 
